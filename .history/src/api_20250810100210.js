...
const openai = new OpenAI({
  apiKey: process?.env?.OPENROUTER_API_KEY || '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',
  ...
  try {
    const response = openai.chat.completions.create({
      model: "moonshotai/kimi-k2:free",
		models: ["moonshotai/kimi-k2:free","openai/gpt-5-chat"],
      messages: [
