...
export default function InputForm({ onAnalyze, loading }) {
  ...
  const examples = [
    {
      a: "Der Sabbat ist für Christen nicht mehr bindend",
      b: "Der Sabbat ist für Christen nicht aufgehoben"
    },
    {
      a: "Als Christen dürfen wir alles Essen",
      b: "Als Christen dürfen wir nicht alles Essen"
    },
    {
